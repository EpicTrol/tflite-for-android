...
[中文流程简介](https://github.com/EpicTrol/tflite-for-android/blob/master/readme-cn.md)
### Overview
...
### Custom model used
[View this example](https://github.com/tensorflow/examples/blob/master/lite/examples/object_detection/android/README.md)